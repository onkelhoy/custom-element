...
// export function RenderAlt(modeOrStrings:string|TemplateStringsArray, ...rest: any[]) {
//   if (Array.isArray(modeOrStrings)) {
//     // Called as html`<div>${...}</div>` (normal call)
//     return handleHtml('default')(modeOrStrings as TemplateStringsArray, ...rest);
//   }

//   // Called as html('compiled')`<div>${...}</div>`
//   return handleHtml(modeOrStrings as string);
// }

// type TemplateTag = (strings: TemplateStringsArray, ...values: any[]) => any;
// function handleHtml(mode:string):TemplateTag {
//   return (strings: TemplateStringsArray, ...values: any[]) => {
//     console.log({mode, strings, values})
//   }
// }
...
// }
// // function valueBuilder(text: string, value:any, executed = 0) {
